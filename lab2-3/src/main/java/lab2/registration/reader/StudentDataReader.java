...
public class StudentDataReader {
    ...
    public Student[] readBachelorStudentData() throws IOException {
        return objectMapper.readValue(new File("D:/java-labs/lab2/src/main/resources/bachelorStudents.json"), Student[].class);
    }
    ...
    public Student[] readMasterStudentData() throws IOException {
        return objectMapper.readValue(new File("D:/java-labs/lab2/src/main/resources/masterStudents.json"), Student[].class);
    }
